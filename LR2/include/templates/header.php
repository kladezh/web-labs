                    ...
                    <div class="offcanvas-body">
                        <div class="navbar-nav justify-content-end flex-grow-1">
                            <div class="nav-itemme-auto ">
                                <a href="#" class="nav-link"><span>Туры</span></a>
                            </div>
                            <div class="nav-itemme-auto ">
                            ...
                            <div class="nav-item navbar-bordered">
                                <a href="#/" class="nav-link btn" role="button" data-bs-toggle="modal" data-bs-target="#loginModal">
                                    <span>Вход</span>
                                </a>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="loginModal" tabindex="-1" aria-labelledby="loginModalLabel">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header pt-4 px-5 mb-4">
                    <h2 class="modal-title my-0">
                        <a href="#/" class="d-inline disabled">Войти</a>
                        или
                        <a href="#/" class="d-inline">Зарегистрироваться</a>
                    </h2>
                ...
                <div class="modal-body px-5">
                    <form>
                        ...
                        <button type="submit" class="btn btn-primary btn-lg w-100 px-4 mt-2">Войти</button>
                    </form>
                </div>
            </div>
        </div>
