    ...
    <header class="fixed-top">
        <nav class="navbar navbar-expand-lg p-0">
            <div class="container">
                ...
                <a class="navbar-brand d-flex justify-content-center align-items-center" href="?controller=main">
                    <img class="d-block" src="views/assets/img/site_logo.png" alt="onlinetours">
                </a>
                    ...
                    <div class="offcanvas-body">
                        <div class="navbar-nav justify-content-end flex-grow-1">
                            <div class="nav-itemme-auto ">
                                <a href="?controller=tours" class="nav-link"><span>Туры</span></a>
                            </div>
                            <div class="nav-itemme-auto ">
